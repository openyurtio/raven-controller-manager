...
import (
	...
	versioned "github.com/openyurtio/raven-controller-manager/pkg/ravencontroller/client/clientset/versioned"
	internalinterfaces "github.com/openyurtio/raven-controller-manager/pkg/ravencontroller/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/openyurtio/raven-controller-manager/pkg/ravencontroller/client/listers/raven/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RavenV1alpha1().Gateways().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RavenV1alpha1().Gateways().Watch(context.TODO(), options)
			},
		},
		&ravenv1alpha1.Gateway{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ravenv1alpha1.Gateway{}, f.defaultInformer)
}
