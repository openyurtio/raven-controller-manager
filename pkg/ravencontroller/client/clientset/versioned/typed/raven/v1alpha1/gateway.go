...
import (
	...
	scheme "github.com/openyurtio/raven-controller-manager/pkg/ravencontroller/client/clientset/versioned/scheme"
...
func newGateways(c *RavenV1alpha1Client) *gateways {
	return &gateways{
		client: c.RESTClient(),
	}
}
